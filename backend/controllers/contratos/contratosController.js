...
const getCultivosProductoraPost = (req, res) => {
    ...
    selectQuery("c.id_crz id_crz_cult, c.id id_cult, p.precio precio, v.nombre nombre, c.calibre calibre", " fah_variedadescrz v, fah_cultivos c, fah_precioscrzpais p ", condicion, '', (err, result) => {
        if (err)
